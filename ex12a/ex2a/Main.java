...
public class Main {
  public static void main(String[] args) {
    ...
    minCostSearch.solve(new MisCanWorld());
    /*
    ...
    bestFirstSearch.solve(new MisCanWorld());
     ...
     * A*アルゴリズム
     */
    InformedSolver aStarSearch = new InformedSolver((state) -> state.g() + state.h());
    aStarSearch.solve(new MisCanWorld());
  }
}